...
def openmm_simulate_charmm_nvt(top_file, pdb_file, worker_id, check_point=None, GPU_index=0,  
    ...
    if output_cm: 
        ...
        simulation.reporters.append(SmartSimContactMapReporter(worker_id, report_freq))
...
def openmm_simulate_amber_nvt(top_file, pdb_file, worker_id, GPU_index=0, 
        output_traj="output.dcd", output_log="output.log", output_cm=None, 
        report_time=10*u.picoseconds, sim_time=10*u.nanoseconds): 
    """
    Start and run an OpenMM NVT simulation with Langevin integrator at 2 fs 
...
def openmm_simulate_amber_fs_pep(pdb_file, worker_id, top_file=None, check_point=None, GPU_index=0,
        output_traj="output.dcd", output_log="output.log", output_cm=None,
        report_time=10*u.picoseconds, sim_time=10*u.nanoseconds):
    """
    Start and run an OpenMM NVT simulation with Langevin integrator at 2 fs 
...
def openmm_simulate_charmm_npt_z(top_file, pdb_file, worker_id, check_point=None, GPU_index=0,
        output_traj="output.dcd", output_log="output.log", output_cm=None,
        report_time=10*u.picoseconds, sim_time=10*u.nanoseconds):
    """
    Start and run an OpenMM NVT simulation with Langevin integrator at 2 fs 
...
def openmm_simulate_amber_npt(top_file, pdb_file, check_point, worker_id, GPU_index=0,
        output_traj="output.dcd", output_log="output.log", output_cm=None,
        report_time=10*u.picoseconds, sim_time=10*u.nanoseconds):
    """
    Start and run an OpenMM NVT simulation with Langevin integrator at 2 fs 
